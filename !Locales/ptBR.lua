...
L = BigWigs:NewBossLocale("The Beasts of Northrend", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Anub'Rekhan", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Archavon the Stone Watcher", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Ignis the Furnace Master", "ptBR")
if L then
...
if L then
	L.stormcaller_brundir = "Tempestário Brundir"
	L.steelbreaker = "Rompeaço"
	L.runemaster_molgeim = "Mestre de Runas Molgeim"
