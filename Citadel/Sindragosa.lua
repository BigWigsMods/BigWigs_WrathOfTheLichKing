...
local mod = BigWigs:NewBoss("Sindragosa", 604)
...
function mod:OnEngage()
	...
	self:Bar(70123, L["grip_bar"], 34, 70117)
end
...
function mod:Grip()
	self:Message(70123, L["boom_message"], "Important", 70123, "Alarm")
	self:Bar(70123, L["boom_bar"], 5, 70123)
	if phase == 2 then
		self:Bar(70123, L["grip_bar"], 67, 70117)
	end
end
...
function mod:AirPhase()
	...
	self:Bar(70123, L["grip_bar"], 80, 70117)
